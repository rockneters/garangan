...
# Tambahan
cd /usr/bin
wget -O addwg "http://juki.my.id/script/vpn/addwg.sh"
wget -O delwg "http://juki.my.id/script/vpn/delwg.sh"
wget -O cekwg "http://juki.my.id/script/vpn/cekwg.sh"
wget -O expwg "http://juki.my.id/script/vpn/expwg.sh"
wget -O renewwg "http://juki.my.id/script/vpn/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x cekwg
chmod +x expwg

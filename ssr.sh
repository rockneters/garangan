...
Start_SSR(){
        check_pid
        wget -O /etc/init.d/ssrmu "https://raw.githubusercontent.com/rockneters/garangan/main/ssrmu"
...
Install_SSR
wget -O /usr/bin/ssr https://raw.githubusercontent.com/rockneters/garangan/main/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/addssr https://raw.githubusercontent.com/rockneters/garangan/main/addssr.sh && chmod +x /usr/bin/addssr
wget -O /usr/bin/delssr https://raw.githubusercontent.com/rockneters/garangan/main/delssr.sh && chmod +x /usr/bin/delssr
wget -O /usr/bin/expssr https://raw.githubusercontent.com/rockneters/garangan/main/expssr.sh && chmod +x /usr/bin/expssr
wget -O /usr/bin/expssr https://raw.githubusercontent.com/rockneters/garangan/main/listssr.sh && chmod +x /usr/bin/listssr

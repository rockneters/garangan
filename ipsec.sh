...
wget -O /usr/bin/addl2tp http://juki.my.id/script/vpn/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp http://juki.my.id/script/vpn/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/expl2tp http://juki.my.id/script/vpn/expl2tp.sh && chmod +x /usr/bin/expl2tp
wget -O /usr/bin/addpptp http://juki.my.id/script/vpn/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp http://juki.my.id/script/vpn/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/expptp http://juki.my.id/script/vpn/expptp.sh && chmod +x /usr/bin/expptp
wget -O /usr/bin/repptp http://juki.my.id/script/vpn/repptp.sh && chmod +x /usr/bin/repptp
wget -O /usr/bin/rel2tp http://juki.my.id/script/vpn/rel2tp.sh && chmod +x /usr/bin/rel2tp
